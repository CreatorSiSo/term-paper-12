...
Others require only a little nonhardware support for their implementation.
[Vgl. @sebesta_2019. S. 400]

More complex types can be created by combining primitive types as we will see in [ref next capter].
...
This is not the case in the subsequent languages, Java and C# which is why Rym will not allow it either.
<!-- [https://docs.oracle.com/javase/specs/jls/se19/html/jls-4.html#jls-4.2.5]
[https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/language-specification/types#839-the-bool-type] -->
...
The Boolean type in Rym is called _bool_ like in Python, PHP, C#, Rust, Swift and many others.
It is named after _George Boole_ who pioneered the field of mathematical logic.
<!--
[https://docs.python.org/3/library/functions.html#bool]
[https://www.php.net/manual/en/language.types.boolean.php]
[https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/language-specification/types#839-the-bool-type]
[https://doc.rust-lang.org/stable/reference/types/boolean.html#boolean-type]
...
<!-- Should bool be a union type of true and false?
```rym
...
Types from this standard header file are however required to that exact size. [Vgl. @iso_9899_2018. S. __TODO__][Vgl. @iso_14882_2020. S. __TODO__]
