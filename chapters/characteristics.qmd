...
To do this, we need a set of evaluation criteria. Such a list of criteria is necessarily controversial,
as it is difficult to get everyone to agree on the value of some given language characteristic relative to others.
In spite of these differences, most would probably agree that the criteria discussed in the following subsections are important.
...
Code is often read more often then written
and maintenance is as a major part of the developement cycle, particularly in terms of cost.
