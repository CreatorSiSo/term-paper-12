...
Syntax, or the form of elements in a language, greatly impacts the readability of programs.
There are various design choices that affect readability,
such as special words, form, and meaning.
Some languages use matching pairs of special words or symbols,
while others use distinct closing syntax,
which can result in greater readability.
However, personal preferences play a role in determining which language is more readable.
The meaning of reserved words can also vary depending on context.
In some cases, the appearance of statements does not suggest their purpose,
leading to difficulties for beginners.
Ultimately, the readability of a programming language is subjective
and depends on individual preferences and prior knowledge.
Which is why adopting parts of the syntax of well known languages into a new one makes a lot of sense.
[@sebesta_2019 S. 48f]
...
A program is said to be reliable if it performs as expected under all conditions
