...
werden die folgenden Kriterien häufig genannt.
...
Da die Wartungsfreund-lichkeit zu einem großen Teil durch die Lesbarkeit von Programmen bestimmt wird,
ist sie eine wichtige Maßnahme zur Verbesserung der Qualität von Programmen und Programmier-sprachen.
...
-->
<!-- TODO write more? -->
Eine dritte Charakteristik, welche die Einfachheit einer Programmiersprache negativ beein-trächtigt,
ist das Vorhandensein zu vieler Möglichkeiten, dieselbe Operation auszuführen.
[@sebesta_2019 S. 43]
...
Dies gilt insbe-sondere für Booleans und Enumerationen.
[@sebesta_2019 S. 47]
...
Dies kann durch eine Syntax erreicht werden, die wie im Englischen^[Englisch ist die Sprache in der die meisten Programmiersprachen geschrieben werden.],
...
Aus diesem Grund sollte eine Sprache möglichst wenige solcher Verhal-tensweisen aufzeigen.
...
wie z.B. Daten-/Kontrollflussanalyse, Bounds- und Typ-Checking.
