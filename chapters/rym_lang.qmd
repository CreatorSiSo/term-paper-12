...
In Rym it is be possible to define a function by using the _func_ keyword followed by a name for the function,
...
In the Rym programming language, a function must be defined with a return type, which specifies the type of value that will be returned by the function.
The return type is specified after the arrow symbol "->"" in the function definition.
The function body may contain any number of statements and expressions, and the value of the last statement in the function body will be returned as the result of the function.
