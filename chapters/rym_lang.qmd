...
Those in the first category produce a new value^[Addition: "+" Subtraktion: "-" Multiplikation: "\*" Division: "/" Rest: "%": Gleichheit: "==" Und: "&" Oder: "|"] and the others change an existing variable ^[Zuweisung: "="].
