...
Monomorphic programming languages may be contrasted with _polymorphic_ (from Greek ‘many shapes’) [Vgl. @stroustrup_2013. S. 760]
languages in which some values may have more than one type. [Vgl. @cardelli_1985]
...
it can be more convenient to give them the same name ^[Vgl. Ebd. Stroustrup. S. 326]
